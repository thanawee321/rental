...
?>
    ...
    <body>
        ...
        <div class="container-fluid pt-3">
            <h1>รายชื่อผู้ใช้บริการ</h1>
            <table class="table table-striped table-dark table-hover text-center" id="viewmember" style="width:100%">
                <thead>
                    <tr>
                        <!--<th>ลำดับ</th>-->
            ...
            <center>
                <a href="registerMember.php" class="btn btn-info">ลงทะเบียนลูกค้า</a>
            </center>
